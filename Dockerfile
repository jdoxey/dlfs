...
RUN wget https://github.com/systemd/systemd/archive/refs/tags/v249.tar.gz --output-document=$LFS/sources/systemd-249.tar.gz
RUN wget https://github.com/ninja-build/ninja/archive/refs/tags/v1.10.2.tar.gz --output-document=$LFS/sources/ninja-1.10.2.tar.gz
